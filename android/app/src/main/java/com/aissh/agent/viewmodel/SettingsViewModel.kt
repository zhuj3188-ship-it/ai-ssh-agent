...
data class SettingsState(
    val serverUrl: String = "http://43.139.24.49:8080/",
...
class SettingsViewModel @Inject constructor(private val repo: SettingsRepository) : ViewModel() {
    ...
    init {
        ...
        viewModelScope.launch { repo.apiKeys.collect { v -> _state.update { it.copy(apiKeys = v) } } }
    ...
    fun setApiKeys(keys: String) = viewModelScope.launch { repo.setApiKeys(keys) }
